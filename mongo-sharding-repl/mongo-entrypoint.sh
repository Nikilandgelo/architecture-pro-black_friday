...
mongosh --host mongo_shard_1 --port 27018 --eval '
  try {
    rs.initiate({_id: "shard1", members: [
      ...
      {_id: 1, host: "mongo_shard_1_1:27023"},
      {_id: 2, host: "mongo_shard_1_2:27024"},
      {_id: 3, host: "mongo_shard_1_3:27025"}
    ]});
  } catch(e) { print(e); }
'
...
mongosh --host mongo_shard_2 --port 27019 --eval '
  try {
    rs.initiate({_id: "shard2", members: [
      {_id: 0, host: "mongo_shard_2:27019"},
      {_id: 1, host: "mongo_shard_2_1:27026"},
      {_id: 2, host: "mongo_shard_2_2:27027"},
      {_id: 3, host: "mongo_shard_2_3:27028"}
    ]});
  } catch(e) { print(e); }
'
